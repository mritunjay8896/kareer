...
export const GovJobDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 pb-16">
      ...
      <div className="bg-white border-b border-slate-200/80 py-2.5 text-slate-600 text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              onClick={handleShare}
              className="inline-flex items-center gap-1 bg-white hover:bg-slate-50 text-slate-700 px-2.5 py-1 rounded-lg text-[11px] font-bold border border-slate-200 transition-colors"
            >
      ...
      <div className="sticky top-[64px] z-30 bg-slate-50/95 backdrop-blur-md border-b border-slate-200/80 shadow-2xs py-1.5 transition-all">
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-md text-[11px] sm:text-xs font-bold whitespace-nowrap transition-all shrink-0 cursor-pointer ${
                    isActive
      ...
      {/* 3. TOP — JOB HEADER (Compact, Light Banner) */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <section className="bg-slate-50/90 p-6 rounded-2xl border border-slate-200/90 shadow-2xs">
                  <h2 className="text-base font-bold text-slate-900 mb-4 flex items-center gap-2 border-b border-slate-200/80 pb-2.5">
                    <Award className="w-5 h-5 text-blue-600" />
                    <span>Recruitment Highlights</span>
                  </h2>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Organization:</span>
                      <span className="font-bold text-slate-800 text-right">{job.organization}</span>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Department:</span>
                      <span className="font-bold text-slate-800 text-right">{job.department || 'Various Central Depts'}</span>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Post Name:</span>
                      <span className="font-bold text-slate-800 text-right">{job.postNames?.[0] || 'Various Posts'}</span>
                    </div>
                    <div className="p-3 bg-blue-50 rounded-xl border border-blue-200/80 flex justify-between">
                      <span className="text-blue-900 font-semibold">Total Vacancies:</span>
                      <span className="font-black text-blue-700">{(job.vacancyDetails?.totalVacancy || 0).toLocaleString()}</span>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Qualification:</span>
                      <span className="font-bold text-slate-800 text-right">{job.eligibility?.educationalQualification?.slice(0, 30) || 'Graduate'}</span>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Job Location:</span>
                      <span className="font-bold text-slate-800 text-right">{job.state}</span>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Application Mode:</span>
                      <span className="font-bold text-slate-800 text-right">Online Only</span>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-slate-200/80 flex justify-between">
                      <span className="text-slate-500 font-medium">Selection Process:</span>
                      <span className="font-bold text-slate-800 text-right">Written Exam + DV</span>
                    </div>
                  </div>
                </section>
                ...
                <section className="bg-blue-50/30 p-6 rounded-2xl border border-blue-100 shadow-2xs">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-center text-xs">
                    {[
                      ...
                      <div key={i} className="p-3 bg-white rounded-xl border border-blue-100/80 flex flex-col items-center">
                        <span className="w-6 h-6 rounded-full bg-blue-600 text-white font-extrabold text-[11px] flex items-center justify-center mb-1.5">
                          {st.step}
                        </span>
                        <span className="font-bold text-slate-900 text-xs mb-0.5">{st.title}</span>
                ...
                <section className="bg-sky-50/30 p-6 rounded-2xl border border-sky-100 shadow-2xs">
                  <h2 className="text-base font-bold text-slate-900 mb-3 flex items-center gap-2 border-b border-sky-200/60 pb-2.5">
                    <Briefcase className="w-5 h-5 text-blue-600" />
                    <span>Job Profile & Nature of Work</span>
                  </h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    <div className="space-y-2 p-3 bg-white/80 rounded-xl border border-sky-100/60">
                ...
                {/* Salary & Pay Scale */}
                <section className="bg-emerald-50/25 p-6 rounded-2xl border border-emerald-100/80 shadow-2xs">
                  <h2 className="text-base font-bold text-slate-900 mb-4 flex items-center gap-2 border-b border-emerald-200/60 pb-2.5">
                    <CreditCard className="w-5 h-5 text-blue-600" />
                    <span>Salary & Pay Scale Details (7th CPC)</span>
                  </h2>

                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs mb-4">
                    <div className="p-3 bg-white rounded-xl border border-emerald-100/80 text-center">
                      <span className="text-[10px] font-bold text-slate-500 uppercase">Pay Level</span>
                      <div className="text-sm font-black text-blue-700 mt-1">Level 4 to Level 8</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-emerald-100/80 text-center">
                      <span className="text-[10px] font-bold text-slate-500 uppercase">Basic Pay Range</span>
                      <div className="text-sm font-extrabold text-slate-800 mt-1">₹25,500 – ₹1,51,100</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-emerald-100/80 text-center">
                      <span className="text-[10px] font-bold text-slate-500 uppercase">Est. In-Hand Salary</span>
                      <div className="text-sm font-extrabold text-emerald-700 mt-1">₹38,000 – ₹78,000/mo</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-emerald-100/80 text-center">
                      <span className="text-[10px] font-bold text-slate-500 uppercase">Allowances</span>
                      <div className="text-xs font-bold text-slate-700 mt-1">DA, HRA, TA, Medical</div>
                    </div>
                  </div>
                </section>
            ...
            {activeTab === 'vacancy' && (
              <div className="space-y-6">
                ...
                <div className="bg-blue-50/80 border border-blue-200 p-6 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 shadow-2xs">
                  <div>
                    <span className="text-xs font-bold text-blue-700 uppercase tracking-wider">Overall Vacancy Summary</span>
                    <h3 className="text-2xl font-black text-slate-900 mt-0.5">
                      {(job.vacancyDetails?.totalVacancy || 0).toLocaleString('en-IN')} Total Vacancies
                    </h3>
                    <p className="text-xs text-slate-600 mt-1">{job.vacancyDetails?.note || 'Subject to central departmental revision'}</p>
                  </div>
                  <div className="bg-blue-600 text-white font-extrabold px-5 py-2.5 rounded-xl text-xs shrink-0 shadow-2xs">
                    Central & State Posts
                  </div>
                </div>
                ...
                {job.categoryWiseVacancy && job.categoryWiseVacancy.length > 0 && (
                  <section className="bg-sky-50/30 p-6 rounded-2xl border border-sky-100 shadow-2xs">
                    <h2 className="text-base font-bold text-slate-900 mb-4 flex items-center gap-2 border-b border-sky-200/60 pb-2.5">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-xs">
                        <thead className="bg-sky-100/60 font-bold text-slate-700 uppercase text-[10px]">
                          <tr>
                            <th className="py-2.5 px-3">Post Name</th>
                            <th className="py-2.5 px-2">UR</th>
                            <th className="py-2.5 px-2">OBC</th>
                            <th className="py-2.5 px-2">SC</th>
                            <th className="py-2.5 px-2">ST</th>
                            <th className="py-2.5 px-2">EWS</th>
                        ...
                        <tbody className="divide-y divide-sky-100/60 bg-white/70">
                          {job.categoryWiseVacancy.map((cat, idx) => (
                            <tr key={idx} className="hover:bg-sky-50/60 transition-colors">
                              <td className="py-2.5 px-3 font-bold text-slate-800">{cat.postName}</td>
                              <td className="py-2.5 px-2 text-slate-600 font-medium">{cat.ur}</td>
                              <td className="py-2.5 px-2 text-slate-600 font-medium">{cat.obc}</td>
                              <td className="py-2.5 px-2 text-slate-600 font-medium">{cat.sc}</td>
                              <td className="py-2.5 px-2 text-slate-600 font-medium">{cat.st}</td>
                              <td className="py-2.5 px-2 text-slate-600 font-medium">{cat.ews}</td>
                              <td className="py-2.5 px-3 text-right font-black text-blue-700">{cat.total}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                ...
                {/* Reservation Info */}
                <section className="bg-indigo-50/30 p-6 rounded-2xl border border-indigo-100 shadow-2xs">
                  <h2 className="text-base font-bold text-slate-900 mb-3 flex items-center gap-2 border-b border-indigo-200/60 pb-2.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div className="p-3 bg-white/80 rounded-xl border border-indigo-100/80">
                      <span className="font-bold text-slate-800 block mb-1">Women Candidates</span>
                      <span className="text-slate-600">Horizontal reservation applicable as per Govt norms.</span>
                    </div>
                    <div className="p-3 bg-white/80 rounded-xl border border-indigo-100/80">
                      <span className="font-bold text-slate-800 block mb-1">PwD Candidates</span>
                      <span className="text-slate-600">4% reservation allocated across benchmark disabilities.</span>
                    </div>
                    <div className="p-3 bg-white/80 rounded-xl border border-indigo-100/80">
                      <span className="font-bold text-slate-800 block mb-1">Ex-Servicemen (ESM)</span>
            ...
            {activeTab === 'eligibility' && (
              <div className="space-y-6">
                ...
                <section className="bg-blue-50/30 p-6 rounded-2xl border border-blue-100 shadow-2xs">
                  ...
                  <p className="text-xs text-slate-700 leading-relaxed font-medium bg-white p-4 rounded-xl border border-blue-100">
                ...
                <section className="bg-sky-50/30 p-6 rounded-2xl border border-sky-100 shadow-2xs">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs mb-5">
                    <div className="p-3 bg-white rounded-xl border border-sky-100">
                      ...
                      <div className="text-base font-black text-slate-800 mt-1">{job.ageLimit?.minimumAge || 18} Years</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-sky-100">
                      <span className="text-slate-500 font-medium">Maximum Age:</span>
                      <div className="text-base font-black text-slate-800 mt-1">{job.ageLimit?.maximumAge || 32} Years</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl border border-sky-100">
                      <span className="text-slate-500 font-medium">Age Cutoff Date:</span>
                      <div className="text-xs font-bold text-blue-700 mt-1">{job.ageLimit?.ageCalculationDate || job.postDate}</div>
                    </div>
                  </div>

                  {job.ageRelaxation && job.ageRelaxation.length > 0 && (
                    <div>
                      <h3 className="text-xs font-bold text-slate-800 mb-2">Upper Age Relaxation:</h3>
                      <div className="overflow-x-auto">
                        <table className="w-full text-left text-xs">
                          <thead className="bg-sky-100/60 font-bold text-slate-600 uppercase text-[10px]">
                            <tr>
                              <th className="py-2 px-3">Category</th>
                              <th className="py-2 px-3">Relaxation Granted</th>
                            </tr>
                          </thead>
                          <tbody className="divide-y divide-sky-100 bg-white">
                            {job.ageRelaxation.map((rel, idx) => (
                              <tr key={idx} className="hover:bg-sky-50/50">
                                <td className="py-2 px-3 font-semibold text-slate-800">{rel.category}</td>
                                <td className="py-2 px-3 font-bold text-blue-700">{rel.relaxationYears}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
                ...
                <section className="bg-indigo-50/25 p-6 rounded-2xl border border-indigo-100 shadow-2xs">
                  ...
                  <div className="space-y-2 text-xs text-slate-700">
                    <div className="p-2.5 bg-white/90 rounded-lg border border-indigo-100/60">
            ...
            {activeTab === 'application' && (
              <div className="space-y-6">
                ...
                <section className="bg-emerald-50/25 p-6 rounded-2xl border border-emerald-100 shadow-2xs">
                  <h2 className="text-base font-bold text-slate-900 mb-4 flex items-center gap-2 border-b border-emerald-200/60 pb-2.5">
                    <ListOrdered className="w-5 h-5 text-blue-600" />
                  ...
                  <ol className="space-y-3 text-xs">
                    {job.howToApply?.map((step, idx) => (
                      <li key={idx} className="flex items-start gap-3 p-2.5 bg-white rounded-xl border border-emerald-100/80">
                        <span className="w-6 h-6 bg-blue-600 text-white font-black text-xs rounded-full flex items-center justify-center shrink-0 mt-0.5">
                          {idx + 1}
                        </span>
                ...
                <section className="bg-sky-50/30 p-6 rounded-2xl border border-sky-100 shadow-2xs">
                  <div className="flex items-center justify-between border-b border-sky-200/60 pb-3 mb-4">
                    ...
                    {job.officialNotificationUrl && (
                      <a
                        ...
                        className="text-xs font-bold text-blue-600 hover:text-blue-700 inline-flex items-center gap-1 bg-white px-3 py-1 rounded-lg border border-sky-100"
                      >
                  ...
                  <div className="space-y-3">
                    {job.syllabus?.map((syl, idx) => {
                      const isOpen = openSyllabusSubjects[idx];
                      return (
                        <div key={idx} className="border border-sky-100 rounded-xl overflow-hidden bg-white">
                          <button
                            onClick={() => toggleSyllabusSubject(idx)}
                            className="w-full p-3.5 bg-sky-50/50 hover:bg-sky-100/60 text-left font-bold text-slate-900 text-xs flex items-center justify-between transition-colors"
                          >
                          ...
                          {isOpen && (
                            <div className="p-4 bg-white border-t border-sky-100 text-xs">
                              <div className="flex flex-wrap gap-2">
                                {syl.topics.map((topic, i) => (
                                  <span key={i} className="px-2.5 py-1 bg-slate-50 text-slate-700 rounded-md font-medium border border-slate-200/60">
                                    {topic}
                                  </span>
                                ))}
                              </div>
                ...
                <section className="bg-blue-50/30 p-6 rounded-2xl border border-blue-100 shadow-2xs">
                  ...
                  <div className="p-4 bg-white rounded-xl border border-blue-100 mb-4">
                    <div className="text-xs font-bold text-slate-700 mb-3">
                      Historical Cutoff Score Trend ({selectedCutoffCat} Category)
                    </div>

                    <div className="grid grid-cols-4 gap-2 items-end h-28 pt-4 pb-1">
                      {cutoffTrendData[selectedCutoffCat].map((item, i) => {
                        const heightPct = Math.round((item.score / 160) * 100);
                        return (
                          <div key={i} className="flex flex-col items-center gap-1 h-full justify-end">
                            <span className="text-[11px] font-black text-blue-700">{item.score}</span>
                            <div className="w-full max-w-[36px] bg-blue-600 rounded-t-md transition-all duration-300" style={{ height: `${heightPct}%` }} />
                            <span className="text-[10px] font-bold text-slate-600 mt-1">{item.year}</span>
                          </div>
                        );
                      })}
                    </div>
            ...
            {activeTab === 'mock' && (
              <div className="space-y-6">
                ...
                <section className="bg-blue-50/30 p-6 rounded-2xl border border-blue-100 shadow-2xs">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-blue-200/60 pb-4 mb-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">Simulate real exam environment with instant rank & performance report.</p>
                    </div>

                    <Link
                      to={job.mockTestUrl || "/mock-tests"}
                      className="bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs px-6 py-3 rounded-xl transition-all shadow-xs shrink-0 flex items-center gap-1.5"
                    >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                    <div className="p-3 bg-white rounded-xl text-center border border-blue-100/60">
                      <div className="text-[10px] text-slate-500 font-bold uppercase">Questions</div>
                      <div className="text-base font-black text-slate-900 mt-1">100 Qs</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl text-center border border-blue-100/60">
                      <div className="text-[10px] text-slate-500 font-bold uppercase">Duration</div>
                      <div className="text-base font-black text-slate-900 mt-1">60 Mins</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl text-center border border-blue-100/60">
                      <div className="text-[10px] text-slate-500 font-bold uppercase">Total Marks</div>
                      <div className="text-base font-black text-blue-700 mt-1">200 Marks</div>
                    </div>
                    <div className="p-3 bg-white rounded-xl text-center border border-blue-100/60">
                      <div className="text-[10px] text-slate-500 font-bold uppercase">Language</div>
                      <div className="text-base font-black text-slate-900 mt-1">Bilingual</div>
                    </div>
                  </div>
                </section>
          ...
          <div className="lg:col-span-4 space-y-5 lg:sticky lg:top-20">
            ...
            {/* SIDEBAR CARD 1 — IMPORTANT DATES */}
            <div className="bg-sky-50/50 p-5 rounded-2xl border border-sky-200/80 shadow-2xs">
              <div className="flex items-center justify-between border-b border-sky-200/60 pb-3 mb-3">
                <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider flex items-center gap-1.5">
                  <Calendar className="w-4 h-4 text-blue-600" />
                  <span>Important Dates</span>
                </h3>

                <span className={`text-[10px] font-black px-2 py-0.5 rounded-full ${isClosingSoon ? 'bg-red-100 text-red-700' : 'bg-emerald-100 text-emerald-800'}`}>
                  {isClosingSoon ? '🔴 Closing Soon' : '🟢 Application Open'}
                </span>
              </div>

              <div className="space-y-2.5 text-xs">
                <div className="flex justify-between items-center p-2 bg-white/90 rounded-lg border border-sky-100/60">
              ...
              <button
                ...
                className="w-full mt-3 py-1.5 text-center text-xs font-bold text-blue-600 hover:text-blue-700 flex items-center justify-center gap-1"
              >
            ...
            {/* SIDEBAR CARD 2 — APPLICATION FEE */}
            <div className="bg-slate-50/90 p-5 rounded-2xl border border-slate-200/90 shadow-2xs">
              <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider mb-3 flex items-center gap-1.5 border-b border-slate-200/80 pb-2.5">
                <CreditCard className="w-4 h-4 text-blue-600" />
                <span>Application Fee</span>
              </h3>

              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="p-2 bg-white rounded-lg border border-slate-200/80 flex justify-between">
                ...
                <div className="p-2 bg-white rounded-lg border border-slate-200/80 flex justify-between col-span-2">
            ...
            <div className="bg-indigo-50/30 p-5 rounded-2xl border border-indigo-100 shadow-2xs">
              <div className="flex items-center justify-between border-b border-indigo-200/60 pb-2.5 mb-3">
                <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider flex items-center gap-1.5">
                ...
                <div className="flex gap-1 bg-white p-0.5 rounded-md text-[10px] border border-indigo-100">
                  {(['UR', 'OBC', 'SC'] as const).map((c) => (
                    <button
                      ...
                      className={`px-1.5 py-0.5 rounded font-extrabold ${selectedCutoffCat === c ? 'bg-blue-600 text-white' : 'text-slate-600'}`}
                    >
                      {c}
                    </button>
                  ))}
              ...
              <div className="grid grid-cols-4 gap-1 items-end h-20 pt-2">
                {cutoffTrendData[selectedCutoffCat].map((item, i) => (
                  <div key={i} className="flex flex-col items-center gap-0.5 h-full justify-end">
                    <span className="text-[10px] font-bold text-blue-700">{item.score}</span>
                    <div className="w-full bg-blue-500/80 rounded-t-xs" style={{ height: `${Math.round((item.score/150)*100)}%` }} />
                    <span className="text-[9px] text-slate-500">{item.year}</span>
                  </div>
                ))}
              </div>
            </div>
